...
@if(isset($call))
{{ Form::model($call, array('route' => array('leadcallUpdate', $lead->id, $call->id), 'method' => 'PUT')) }}
@else
{{ Form::open(array('route' => ['leadcallStore',$lead->id])) }}
@endif
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-6 form-group">
            {{ Form::label('call_type', __('Call Type'),['class'=>'col-form-label required']) }}
        ...
        <div class="col-12 form-group">
            {{ Form::label('duration', __('Duration'),['class'=>'col-form-label required']) }} <small class="font-weight-bold">{{ __(' (Format h:m:s i.e 00:35:20 means 35 Minutes and 20 Sec)') }}</small>
        ...
        <div class="col-12 form-group">
            ...
            {{ Form::textarea('call_result', null, array('class' => 'form-control')) }}
        </div>
    </div>
</div>
