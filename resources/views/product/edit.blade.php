...
{{ Form::model($productService, array('route' => array('products.update', $productService->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data')) }}
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea class="form-control" rows="4" name="description" cols="50" id="description" placeholder="Enter Description">{{ $productService->description }}</textarea>
            </div>
        </div>
    </div>
</div>
...
<div class="modal-footer">
    ...
    <button type="submit" class="btn  btn-primary" id="updateButton">{{__('Save Changes')}}</button>
</div>
{{ Form::close() }}
