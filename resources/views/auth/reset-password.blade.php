        ...
        <div class="col-lg-6 align-self-start">
            <div class="account-info-area" style="background-image: url(images/rainbow.gif)">
                <div class="login-content">
                    <p class="sub-title">Forgot Password to your admin dashboard with your credentials</p>
        ...
        <div class="col-md-6 align-self-start">
            <div class="login-form">
                    ...
                    <div class="col-xl-6 col-sm-6">
                        <a href="javascript:void(0);" class="btn btn-outline-dark d-block apple social-btn">
                            <svg clip-rule="evenodd" fill-rule="evenodd" height="16" image-rendering="optimizeQuality"
                                ...
                                viewBox="0 0 256002 256300" width="16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="mb-4">
                    ...
                    {{ Form::text('email', $request->email, ['class' => 'form-control', 'readonly']) }}
                    @error('email')
...
@push('after-scripts')
    <script>
        function togglePasswordVisibility(passwordInputId, toggleBtnId) {
            var passwordInput = document.getElementById(passwordInputId);
            var passwordToggle = document.querySelector('.' + toggleBtnId);
