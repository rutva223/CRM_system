    ...
    <nav class="navbar navbar-expand">
        <div class="collapse navbar-collapse justify-content-between">
            ...
            <ul class="navbar-nav header-right">
                ...
                <li class="nav-item dropdown notification_dropdown">
                    <a class="nav-link bell-link" href="{{ route('plans.index')}}">
                        <img src="https://cdn-icons-png.freepik.com/256/8975/8975982.png?ga=GA1.1.898392996.1708158571&semt=ais" alt="" style="height: 22px;">
                    </a>
                </li>
                <li class="nav-item dropdown notification_dropdown">
                                ...
                                <li>
                                    <div class="timeline-panel">
                                        <div class="media me-2">
                                            <img alt="image" width="50" src="{{ asset('assets/images/avatar/1.png') }}">
                                        </div>
