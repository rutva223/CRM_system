...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-12">
            {{ Form::label('color', __('Color'),['class'=>'col-form-label required']) }}
            <div class="row gutters-xs">
                @foreach($colors as $color)
                    <div class="col-auto">
                        <label class="badge badge-{{$color}}">
                            <input name="color" type="radio" value="{{$color}}" @if($label->color == $color) checked @endif class="colorinput-input" required>
