...
{{-- <body data-theme-version="{{ $theme }}"> --}}
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
				<svg class="logo-abbr" width="30" height="30" viewBox="0 0 64 61" fill="none" xmlns="http://www.w3.org/2000/svg" src="./images/logo-white.png">
					<path d="M7.0188 22.6571H56.1512L49.1323 33.9857H28.0756L38.6039 49.6714L31.585 61L7.0188 22.6571Z" fill="var(--primary)"></path>
				...
				<div class="brand-title" src="images/logo-text-white.png">
					<svg width="90" height="35" viewBox="0 0 176 44" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M23.9171 4.94226V11.1817H7.83215V21.0653H20.1581V27.1942H7.83215V43.4827H0.09375V4.94226H23.9171Z" fill="#2A353A"></path>
						...
						<path d="M89.0701 37.3538H101.783V43.4827H81.3311V4.94226H89.0701V37.3538Z" fill="#2A353A"></path>
  ...
  ***********************************-->
        <div class="footer outer-footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="https://zaropay.com/"
                        target="_blank">ZaroPay</a> <?php echo date('Y'); ?></p>
            </div>
        </div>
        <!--**********************************
            Footer end
