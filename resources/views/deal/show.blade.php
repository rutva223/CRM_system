...
@push('css')
    ...
    <link rel="stylesheet" href="{{asset('Resources/assets/css/dropzone.min.css')}}">
    <link rel="stylesheet" href="{{asset('Resources/assets/js/summernote-bs4.css')}}">
@endpush
...
@push('scripts')
    ...
    <script src="{{asset('Resources/assets/js/dropzone.min.js')}}"></script>
    <script src="{{asset('Resources/assets/js/summernote-bs4.js')}}"></script>
    <script>
        ...
        var mockFile2 = {name: "{{$file->file_name}}", size: "{{ get_size($file->file_path) }}" };
        // Call the default addedfile event handler
        myDropzone2.emit("addedfile", mockFile2);
        // And optionally show the thumbnail of the file:
        myDropzone2.emit("thumbnail", mockFile2, "{{ $file->file_path }}");
        myDropzone2.emit("complete", mockFile2);

        dropzoneBtn(mockFile2, {download: "{{ $file->file_path }}", delete: "{{route('deals.file.delete',[$deal->id,$file->id])}}"});
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="ms-2">
                                                ...
                                                <h5 class="text-warning">{{$deal->created_at}}</h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="ms-2">
                                                ...
                                                <h5 class="text-danger">{{$deal->price}}</h5>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    @can('edit deal')
                                        ...
                                        {{ Form::open(array('route' => array('deals.change.status',$deal->id),'id'=>'change-deal-status')) }}
                                            {{ Form::select('deal_status', App\Models\Deal::$statues,$deal->status, array('class' => 'form-control select2 px-1','id'=>'deal_status')) }}
                                            {{ Form::close() }}
                                        </span>
                                    @endcan
                                </div>
                                                    ...
                                                    <table class="table align-items-center mb-0">
                                                        <tbody class="list">
                                                            @foreach($deal->users as $user)
                                                                <tr>
                                                                    <td>
                                                                        <a @if($user->avatar) href="{{$user->avatar}}" @else href="{{asset('uploads/users-avatar/avatar.png')}}" @endif target="_blank">
                                                                            <img @if($user->avatar) src="{{$user->avatar}}" @else src="{{asset('uploads/users-avatar/avatar.png')}}" @endif width="30" class="avatar-sm rounded-circle">
                                                                        </a>
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    @foreach($emails as $email)
                                                        <li class="media mb-3">
                                                            <div style="margin-right: 10px;">
                                                                <a @if($user->avatar) href="{{$user->avatar}}" @else href="{{asset('custom/img/avatar/avatar-1.png')}}" @endif target="_blank">
                                                                    <img @if($user->avatar) src="{{$user->avatar}}" @else src="{{asset('custom/img/avatar/avatar-1.png')}}" @endif width="30" class="avatar-sm rounded-circle">
                                                                </a>
                                                            </div>
                                                ...
                                                @foreach($deal->discussions as $discussion)
                                                    <li class="media">
                                                        <div style="margin-right: 10px;">
                                                            ...
                                                            <a @if($discussion->user->avatar) href="{{$discussion->user->avatar}}" @else href="{{asset('uploads/users-avatar/avatar.png')}}" @endif target="_blnak">
                                                                <img @if($discussion->user->avatar) src="{{$discussion->user->avatar}}" @else src="{{asset('uploads/users-avatar/avatar.png')}}" @endif width="50" class="avatar-sm rounded-circle">
                                                            </a>
                                                        </div>
                                                            <div class="media-body">
                                                ...
                                                <table class="table mb-0 pc-dt-simple" id="client_call">
                                                    ...
                                                    <tbody>
                                                        @foreach ($deal->clients as $client)
                                                            <tr>
                                                                <td>
                                                                    <a href="@if($client->avatar) {{$client->avatar}} @else {{asset('uploads/users-avatar/avatar.png')}} @endif" target="_blnak">
                                                                        <img src="@if($client->avatar) {{$client->avatar}} @else {{asset('uploads/users-avatar/avatar.png')}} @endif" class="rounded-circle mr-1" width="50"></td>
                                                                    </a>
