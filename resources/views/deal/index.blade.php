        ...
        <div class="col-xl-12">
            <div class="kanban-header">
                <div class="left-title">
                    <div>
                        <h4 class="me-3 mb-0">Development Task</h4>
                        <p class="mb-0">Sed eligendi facere repellendus. Ipsam ipsam incidunt minima harum tenetur.</p>
                    </div>
                    <div class="d-flex align-items-center flex-wrap mt-2">
                        <span class="me-3 text-primary">Total Progress 60%</span>
                        <div class="progress default-progress w-25 h-auto">
                            <div class="progress-bar bg-gradient1 progress-animated" style="width: 45%; height:6px;"
                                role="progressbar">
                ...
                <div class="right-title">
                    <div class="title-content">
                        <div class="bread-star">
                            <svg width="24" height="24" viewBox="0 0 28 26" fill="none"
                        ...
                        <ul class="kanbanimg me-3">
                            <li><img src="images/profile/small/pic1.jpg" class="avatar avatar-sm rounded-circle"
                                    alt=""></li>
                            <li><img src="images/profile/small/pic2.jpg" class="avatar avatar-sm rounded-circle"
                                    alt=""></li>
                            <li><img src="images/profile/small/pic5.jpg" class="avatar avatar-sm rounded-circle"
                                    alt=""></li>
                            <li><span>5+</span></li>
                        </ul>
                        <div class="ms-3 bread-btn">
                            <a href="#" class="btn btn-primary btn-sm" data-ajax-popup="true"
                            data-bs-toggle="tooltip" data-title="{{ __('Add New Deal') }}" data-url="{{ route('deals.create') }}"
                            data-size="md" >Invite<svg class="ms-2" width="24" height="24"
            ...
            <div class="kanbanPreview-bx">
                <div class="draggable-zone dropzoneContainer">
                    ...
                    <div class="card draggable-handle draggable">
                        <div class="card-body">
                            <div class=" kanban-user">
                                <span class="badge light badge-secondary badge-md  mb-0">Illustration</span>
                                <ul class="users">
                                    <li><img src="images/profile/small/pic2.jpg" class="avatar avatar-xs rounded-circle"
                                            alt=""></li>
                                    <li><img src="images/profile/small/pic3.jpg" class="avatar avatar-xs rounded-circle"
                                            alt=""></li>
                                    <li><img src="images/profile/small/pic4.jpg" class="avatar avatar-xs rounded-circle"
                                            alt=""></li>
                                    <li><img src="images/profile/small/pic5.jpg" class="avatar avatar-xs rounded-circle"
                                            alt=""></li>
                                    <li><span>5+</span></li>
                                </ul>
                            </div>
                            <h6><a href="javascript:void(0);">Create Empty State</a></h6>
                            <p class="mb-0">Task Done: <strong class="text-secondary">5/10</strong></p>
                            <div class="progress default-progress mb-3 mt-2 h-auto">
                                <div class="progress-bar bg-secondary progress-animated" style="width: 45%; height:6px;"
                                    role="progressbar">
                                    <span class="sr-only">45% Complete</span>
                                </div>
                            </div>
                    ...
                    <div class="card draggable-handle draggable">
                        <div class="card-body">
                            <div class=" kanban-user">
                                <span class="badge light badge-danger badge-md">Design</span>
                                <ul class="users">
                                    <li><img src="images/profile/small/pic2.jpg" class="avatar avatar-xs rounded-circle"
                                            alt=""></li>
                                    <li><img src="images/profile/small/pic3.jpg" class="avatar avatar-xs rounded-circle"
                            ...
                            <h6><a href="javascript:void(0);">Doing Research</a></h6>
                            <p class="mb-0">Task Done: <strong class="text-danger">5/10</strong></p>
                            <div class="progress default-progress mb-3 mt-2 h-auto">
                                <div class="progress-bar bg-danger progress-animated" style="width: 45%; height:6px;"
                                    role="progressbar">
                                    <span class="sr-only">45% Complete</span>
                                </div>
                            </div>
            ...
            <div class="kanbanPreview-bx">
                <div class="draggable-zone dropzoneContainer">
                    ...
                    <div class="card draggable-handle draggable">
                        <div class="card-body">
                            <div class=" kanban-user">
                                <span class="badge light badge-secondary">Illustration</span>
                                <ul class="users">
                                    <li><img src="images/profile/small/pic2.jpg" class="avatar avatar-xs rounded-circle"
                                            alt=""></li>
                                    <li><img src="images/profile/small/pic3.jpg" class="avatar avatar-xs rounded-circle"
                            ...
                            <h6><a href="javascript:void(0);">Homepage Illustration</a></h6>
                            <p class="mb-0">Task Done: <strong class="text-secondary">5/10</strong></p>
                            <div class="progress default-progress mb-3 mt-2 h-auto">
                                <div class="progress-bar bg-secondary progress-animated" style="width: 45%; height:6px;"
                                    role="progressbar">
                    ...
                    <div class="card draggable-handle draggable">
                        <div class="card-body">
                            <div class=" kanban-user">
                                <span class="badge light badge-info">Development</span>
                                <ul class="users">
                                    <li><img src="images/profile/small/pic2.jpg" class="avatar avatar-xs rounded-circle"
                                            alt=""></li>
                                    <li><img src="images/profile/small/pic3.jpg" class="avatar avatar-xs rounded-circle"
                            ...
                            <h6><a href="javascript:void(0);">Debugging</a></h6>
                            <p class="mb-0">Task Done: <strong class="text-info">5/10</strong></p>
                            <div class="progress default-progress mb-3 mt-2 h-auto">
                                <div class="progress-bar bg-info progress-animated" style="width: 45%; height:6px;"
                                    role="progressbar">
                                    <span class="sr-only">45% Complete</span>
                                </div>
                            </div>
                    ...
                    <div class="card draggable-handle draggable">
                        <div class="card-body">
                            <div class=" kanban-user">
                                <span class="badge light badge-danger">Copywriting</span>
                                <ul class="users">
                                    <li><img src="images/profile/small/pic2.jpg" class="avatar avatar-xs rounded-circle"
                                            alt=""></li>
                                    <li><img src="images/profile/small/pic3.jpg" class="avatar avatar-xs rounded-circle"
                            ...
                            <h6><a href="javascript:void(0);">Create a Content</a></h6>
                            <p class="mb-0">Task Done: <strong class="text-danger">5/10</strong></p>
                            <div class="progress default-progress mb-3 mt-2 h-auto">
                                <div class="progress-bar bg-danger progress-animated" style="width: 45%; height:6px;"
                                    role="progressbar">
                ...
                <div class="draggable-zone dropzoneContainer">
                    ...
                    <div class="card draggable-handle draggable">
                        <div class="card-body">
                            ...
                            <h6><a href="javascript:void(0);">Create a Caption</a></h6>
                            <p class="mb-0">Task Done: <strong class="text-danger">5/10</strong></p>
                            <div class="progress default-progress mb-3 mt-2 h-auto">
                                <div class="progress-bar bg-danger progress-animated" style="width: 45%; height:6px;"
                                    role="progressbar">
                    ...
                    <div class="card draggable-handle draggable">
                        <div class="card-body">
                            <div class=" kanban-user">
                                <span class="badge light badge-primary">Design</span>
                                <ul class="users">
                                    <li><img src="images/profile/small/pic2.jpg" class="avatar avatar-xs rounded-circle"
                                            alt=""></li>
                                    <li><img src="images/profile/small/pic3.jpg" class="avatar avatar-xs rounded-circle"
                            ...
                            <h6><a href="javascript:void(0);">Create Empty State</a></h6>
                            <p class="mb-0">Task Done: <strong class="text-primary">5/10</strong></p>
                            <div class="progress default-progress mb-3 mt-2 h-auto">
                                <div class="progress-bar bg-primary progress-animated" style="width: 45%; height:6px;"
                                    role="progressbar">
                                    <span class="sr-only">45% Complete</span>
                                </div>
                            </div>
